...
export PATH="/nix/store/fya3qmsm9rqky5f2fblh2yjvdp06f8wk-git-2.44.1/bin:/nix/store/7xwbkzfrs6flyvjyvd23m8r2mlnycinq-gnused-4.9/bin:/nix/store/18zr0fxqs5k1brllvfwkmk4c2sf1lg98-nixos-rebuild/bin:/nix/store/cdhlrh91iq55jripx0v6pv6zz34zq2d3-nixos-install-tools-24.05pre-git/bin:$PATH"
