...
in {
	...
	age.secrets.nxc-builder-ssh-ed25519-private = {
		file = ../secrets/nxc-builder-ssh-ed25519-private.age;
	...
	# Set the pubkey
	environment.etc."ssh/ssh_builder_ed25519_key.pub".text = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJxvj9wuU5bsueGrMlNQN63OtwfnYfy6YMGnBy8zf8O6 builder@nxc";
