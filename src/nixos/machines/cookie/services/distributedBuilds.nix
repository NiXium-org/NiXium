...
in mkIf config.nix.distributedBuilds {
	...
	age.secrets.cookie-builder-ssh-ed25519-private = {
		file = ../secrets/cookie-builder-ssh-ed25519-private.age;
	...
	# Set the pubkey
	environment.etc."ssh/ssh_builder_ed25519_key.pub".text = "ssh-ed25519 ADD_ME builder@cookie";
