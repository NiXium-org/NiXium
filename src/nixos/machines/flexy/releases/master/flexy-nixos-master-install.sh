...
###! This script performs declarative installation of NiXium-Managed NixOS MASTER for the FLEXY system
###!
###! For that we utilize:
...
nixos-rebuild build --flake "$FLAKE_ROOT#nixos-flexy-master" # pre-build the configuration
