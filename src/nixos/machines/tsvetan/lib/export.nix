...
# Module exporting configuration from SINNENFREUDE to other systems

{
	# SSHD on Onions
		# Add this system into Tor's MapAddress so that we can refer to it easier
		# age.secrets.sinnenfreude-onion = {
		# 	file = ../secrets/tsvetan-onion.age;
		...
		# 	config.age.secrets."tsvetan-onion".path
		# ];
}
