...
###! This script performs declarative installation of NiXium-Managed NixOS MASTER for the TUPAC system
###!
###! For that we utilize:
...
if [ -s "$ragenixIdentity" ]; then
	...
	[ -s "/run/agenix/tupac-disks-password" ] || echo "000000" > "/run/agenix/tupac-ssh-ed25519-private"
