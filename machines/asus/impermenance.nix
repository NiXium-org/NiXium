...
let
	inherit (lib) mkIf;
in {
	boot.initrd.luks.devices."luks-3f91458d-a1a5-4351-a422-1470844800f2".device = "/dev/disk/by-uuid/3f91458d-a1a5-4351-a422-1470844800f2"; # Nix-store
	boot.initrd.luks.devices."luks-a3a28fb8-883c-404a-a312-cc20bf9e9890".device = "/dev/disk/by-uuid/a3a28fb8-883c-404a-a312-cc20bf9e9890"; # SWAP
